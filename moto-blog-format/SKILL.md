...
博文副标题显示版本号，**每次内容更新（即使小改）都要递增版本号**：

```html
<p class="subtitle">版本 vX.Y · 日期 更新说明</p>
```

- 格式：`v主.次`，如 `v2.0 → v2.1 → v2.2`
- 每次更新：递增版本号 + 更新日期 + 更新说明
- 适用：所有内容改动（数据修正、章节整理、排版优化都算）
- 当前版本：v2.1（2026-08-23 踏板章节整理二次优化）
